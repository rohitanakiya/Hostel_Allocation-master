#This is a demo of the top trading cycle algorithm with hard coded input.
...
Graph(['Archit', 'Rahul', 'Raghav', 'Shubham'], {'Archit':1, 'Rahul':2, 'Raghav':4, 'Shubham':3}, 
        {'Archit':[1, 3, 2, 4], 'Rahul':[3, 1, 2, 4], 'Raghav':[3, 4, 1, 2], 'Shubham':[1, 4, 3, 2]} )
